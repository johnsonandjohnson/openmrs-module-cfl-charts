...
# OpenMRS Report Charts Module

## Description

The Report Charts module allows to configure selected reports and then see the data visualization presented on the charts as well as downloading a csv file with the data presented in the chart.
